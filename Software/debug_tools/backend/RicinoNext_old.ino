...
#define DEBOUNCE_SECOND 3
#define TOO_LATE_FOR_INIT_RACER 20
#define JSON_BUFFER 300
#define CAR_IRCODE_START 0xAA //debug stuff
#define CAR_NUMBER 8
#define RED_PIN 4
#define GREEN_PIN 6
...
struct racerMemory racerBuffer[CAR_NUMBER];
...
void irReceiver_init()
{
    ...
    // add checkpoint here
    // IrReceiver_checkpoint1.begin(IR_RECEIVE_PIN_1, false);
    // IrReceiver_checkpoint2.begin(IR_RECEIVE_PIN_2, false);
}
...
//              IrReceiver.printIRResultRawFormatted(&Serial, true);
        ...
        if (IrReceiver.decodedIRData.command == 0x42 && irCodeValid) {
            irCode = IrReceiver.decodedIRData.address;
        }
...
bool isRankChanged(){
  static uint16_t totalLapsLast = 0;
...
//example algo...
//aRankOrder.laps[]     4 3 5 2 3 4 6 7
//aRankOrder.prevLaps[] 3 3 5 2 3 5 6 7

//aRankOrder.rank[]     7 6 2 5 1 4 0 3   //view as memoryRacer
//aRankOrder.rank...    f 6 2 5 1 0 4 3
//idChanged = 0;
//idRank = 6;
//aheadId = 4
void updateRankLoop(){
